...
const FloatingWhatsApp: React.FC = () => {
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: '50%', width: '32px', height: '32px' }}>
        <svg
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .floating-whatsapp { padding: 0.75rem !important; border-radius: 50% !important; }
        }
      `}</style>
    </a>
  )
